...
def font_size_splitter(font_map):
    ...
    for font in fonts:
        ...
        elif FONT_SMALL_THRESHOLD < length <= FONT_MEDIUM_THRESHOLD:
            medium_font.append(font)
        elif FONT_MEDIUM_THRESHOLD < length <= FONT_LARGE_THRESHOLD:
...
def wizard_font(text):
    ...
    elif TEXT_XLARGE_THRESHOLD < text_length <= TEXT_LARGE_THRESHOLD:
        font = random.choice(LARGE_WIZARD_FONT)
    elif TEXT_LARGE_THRESHOLD < text_length <= TEXT_MEDIUM_THRESHOLD:
